                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">User join</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Teacher</h6>
                ...
                <div class="card">
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 name">
                                <h5 class="font-bold">Super Administrator</h5>
                                <h6 class="text-muted mb-0">@rayhan_rezki</h6>
                            </div>
                        </div>
                    </div>
                </div>
